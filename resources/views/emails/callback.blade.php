...
<head>
    ...
    <title>Замовлення зворотного дзвінка</title>
    <style>
        body {
...
<div class="container">
    <div class="header">
        <h1>Замовлення зворотного дзвінка</h1>
    ...
    <div class="content">
        <div class="field-group">
            ...
            <div class="value">{{ $callbackData['name'] }}</div>
        </div>

        <div class="field-group">
            <div class="label">Номер телефону</div>
            <div class="value">
                <a href="tel:{{ preg_replace('/[^0-9+]/', '', $callbackData['phone']) }}" style="color: #b86f17; text-decoration: none; font-weight: 600;">
                    {{ $callbackData['phone'] }}
                </a>
            </div>
        </div>
        ...
        <div class="field-group" style="margin-top: 30px; border-bottom: none; padding-bottom: 0;">
            <div style="font-size: 11px; color: #766748; text-align: right;">
                IP-адреса відправника: {{ $callbackData['ip'] ?? 'N/A' }} | Час: {{ date('d.m.Y H:i:s') }}
            </div>
        </div>
    </div>
